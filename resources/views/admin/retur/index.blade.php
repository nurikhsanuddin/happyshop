          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable">
              ...
              <tbody>
                  ...
                  <tr>
                      <td>{{ $key+1 }}</td>
                      <td>{{ $retur->supplier_name }}</td>
                      <td>{{ $retur->supply_date }}</td>
                      <td>
                          <a href="{{ route('admin.retur.show', $retur->id) }}"><i class="fas fa-eye"></i></a>
                          <a href="#" data-target="#delete" data-toggle="modal" data-id="{{ $retur->id }}"><i class="fas fa-trash"></i></a>
                      </td>
                  </tr>
                  @endforeach
              </tbody>
